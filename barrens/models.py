...
class Word(models.Model):
    ...
    audiofile = models.FileField(blank=True,null=True,upload_to='barrensaudio/',validators=[validatefileextension] )
    def __str__(self):
        return self.kalame
...
class Levelstring(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE,related_name='levelstringb')
